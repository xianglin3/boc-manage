/**
 * Created by wxt on 2017/08/01.
 */
$(document).ready(function () {
    var ipspace_id;
    var ipspace_display;
    $(".preloader").removeClass("hidden");
    $.get("/static/app/ipplain/json_info/ipspacelv2Thead.json", function (d) {
        table.init(d);
    }, "json");
    var table = {
        ele: "#examination",
        thead: null,
        url: "/ipplain/ipspacelist/2/",//获取表格数据接口
        lang: {
            "sProcessing": "处理中...",
                ...
                "ajax": {
                    ...
                    "dataSrc": function (jsonData) {
                        $.each(jsonData['data'], function (i, v) {
                            v['opt'] = '<a class="btn btn-primary" href="/ipplain/ipspace/2/' + v["id"] + '" target="_blank" class="btn btn-info btn-sm">编辑</a>';
        ...
        addEvent: function () {
            $(this.ele).on("click", "tbody>tr", function () {
                ...
                window.open("/ipplain/ipspacelevel2/edit/" + id, "_blank");
            });
        }
    };
